...
/**
 * Compare model ids ignoring the `claude-` prefix and a date suffix. A bare
 * alias (`opus`, `fable`) matches any of its versions, so a note is only
 * raised when the ids are unambiguously different.
 */
